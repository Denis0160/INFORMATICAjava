...
public class GiocoLotto {
    public static void main(String[] Args) {
        ...
        double costS = 11.23, costA =5.62, costT =3.74 , costQ = 2.81, costC =2.25 ;
    ...
    public static double calcoloVincita(int NumR, double Cost, double puntata,int Contatore) {
        double vincita;
